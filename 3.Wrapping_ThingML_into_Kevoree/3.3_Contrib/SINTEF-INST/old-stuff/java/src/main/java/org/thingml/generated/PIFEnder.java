 ...
 **/
public class PIFEnder extends Component  {
...
transitions_PIFEnder_behavior.add(new Transition("Handler_27215064",pif_tokenType, from_starter_port, state_PIFEnder_behavior_Init, state_PIFEnder_behavior_Init){
@Override
